return {
    ...
    keys = {
        ...
        -- moving between splits (works in normal and visual mode)
        { '<C-h>',      function() require('smart-splits').move_cursor_left() end,     desc = "Move to Split Left",      mode = { "n", "v" } },
        { '<C-j>',      function() require('smart-splits').move_cursor_down() end,     desc = "Move to Split Down",      mode = { "n", "v" } },
        { '<C-k>',      function() require('smart-splits').move_cursor_up() end,       desc = "Move to Split Up",        mode = { "n", "v" } },
        { '<C-l>',      function() require('smart-splits').move_cursor_right() end,    desc = "Move to Split Right",     mode = { "n", "v" } },
        { '<C-\\>',     function() require('smart-splits').move_cursor_previous() end, desc = "Move to Split Prev",      mode = { "n", "v" } },
